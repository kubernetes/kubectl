...
require (
	...
	k8s.io/client-go v0.0.0-20191025225929-f79cf5fbef3d
...
replace (
	...
	k8s.io/client-go => k8s.io/client-go v0.0.0-20191025225929-f79cf5fbef3d
	...
	k8s.io/metrics => k8s.io/metrics v0.0.0-20191025231619-a113c8ab860e
)
