...
require (
	...
	k8s.io/client-go v0.0.0-20251218142908-d008946b234b
	...
	k8s.io/metrics v0.0.0-20251204234210-9425d1ba29bc
...
replace k8s.io/code-generator => k8s.io/code-generator v0.0.0-20251218023844-9e814c2dceb6
