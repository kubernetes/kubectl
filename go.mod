...
require (
	...
	k8s.io/metrics v0.0.0-20220329053021-dc6ff944cbd1
...
replace (
	k8s.io/api => k8s.io/api v0.0.0-20220330011017-6519413ffeb8
	...
	k8s.io/client-go => k8s.io/client-go v0.0.0-20220329211335-0c14d0c48569
