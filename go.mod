...
require (
	...
	k8s.io/component-base v0.0.0-20191114102137-a5e27780492f
	k8s.io/klog v1.0.0
...
replace (
	...
	k8s.io/api => k8s.io/api v0.0.0-20191114012750-7fcb4fff2e62
	...
	k8s.io/component-base => k8s.io/component-base v0.0.0-20191114102137-a5e27780492f
