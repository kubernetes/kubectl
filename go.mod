...
require (
	...
	k8s.io/metrics v0.0.0-20240111214713-7e16510c7ec5
...
replace (
	...
	k8s.io/code-generator => k8s.io/code-generator v0.0.0-20240116211422-70ef78956abf
	...
	k8s.io/metrics => k8s.io/metrics v0.0.0-20240111214713-7e16510c7ec5
)
