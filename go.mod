...
require (
	...
	k8s.io/cli-runtime v0.0.0-20200831054746-b5105397841b
	...
	k8s.io/metrics v0.0.0-20200831054602-a857a28192cf
...
replace (
	...
	k8s.io/cli-runtime => k8s.io/cli-runtime v0.0.0-20200831054746-b5105397841b
	...
	k8s.io/metrics => k8s.io/metrics v0.0.0-20200831054602-a857a28192cf
)
