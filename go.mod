...
require (
	...
	k8s.io/api v0.0.0-20220324090947-eba027b9383d
...
replace (
	k8s.io/api => k8s.io/api v0.0.0-20220324090947-eba027b9383d
	...
	k8s.io/code-generator => k8s.io/code-generator v0.0.0-20220324053133-c5df4884ec23
