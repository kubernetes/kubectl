...
replace (
	...
	k8s.io/cli-runtime => k8s.io/cli-runtime v0.0.0-20201107124006-d37c4734ef0c
	...
	k8s.io/component-helpers => k8s.io/component-helpers v0.0.0-20201107122811-200b091cbf2c
	k8s.io/metrics => k8s.io/metrics v0.0.0-20201107123901-0371c18f5315
)
