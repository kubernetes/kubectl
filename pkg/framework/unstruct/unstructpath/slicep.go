...
func (p sliceNot) Match(v unstruct.Slice) bool {
	return !p.vp.Match(v)
}
...
func (p sliceAnd) Match(slice unstruct.Slice) bool {
...
func (p sliceLength) Match(s unstruct.Slice) bool {
	return p.ip.Match(float64(s.Length()))
}
